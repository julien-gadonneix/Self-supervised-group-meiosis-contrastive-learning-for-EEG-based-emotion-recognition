...
x_train_DREAMER, x_test_DREAMER, y_train_DREAMER, y_test_DREAMER = train_test_split(DATA, LABEL, random_state=42, test_size=0.3)
x_test_DREAMER, x_val_DREAMER, y_test_DREAMER, y_val_DREAMER = train_test_split(x_test_DREAMER, y_test_DREAMER, random_state=42, test_size=0.5)
# np.save('DATA_DREAMER.npy',DATA)
# np.save('LABEL_DREAMER.npy',LABEL)
np.save('x_train_DREAMER.npy',x_train_DREAMER)
np.save('x_test_DREAMER.npy',x_test_DREAMER)
np.save('x_val_DREAMER.npy',x_val_DREAMER)
np.save('y_train_DREAMER.npy',y_train_DREAMER)
np.save('y_test_DREAMER.npy',y_test_DREAMER)
np.save('y_val_DREAMER.npy',y_val_DREAMER)